...
const bookData = {
  2024: [
    { data: "PhDs", percentage: 40 },
    { data: "Post Graduates", percentage: 35 },
    { data: "Graduates", percentage: 25 },
  ],
  2023: [
    { data: "PhDs", percentage: 37 },
    { data: "Post Graduates", percentage: 32 },
    { data: "Graduates", percentage: 28 },
  ],
};
    ...
    <Card>
      <CardHeader>
        <div className="flex justify-between">
          <div>
            <CardTitle>Academic Staff Qualification Levels</CardTitle>
          </div>
          <div>
            <Select
                ...
                if (payload && payload.length) {
                  ...
                  return (
                    <div className="flex gap-1 p-2 rounded bg-card">
                      <p>Staff Qualification Levels</p>-----
                      <p>{percentage}</p>
                    </div>
                  );
                }
