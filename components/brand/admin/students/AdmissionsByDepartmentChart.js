...
const bookData = {
  2024: [
    { data: "Medicine", percentage: 100 },
    { data: "Surgery", percentage: 80 },
    { data: "Pediatrics", percentage: 60 },
    { data: "Oncology", percentage: 40 },
    { data: "Gynecology", percentage: 20 },
  ],
  2023: [
    { data: "Medicine", percentage: 100 },
    { data: "Surgery", percentage: 80 },
...
export default function AdmissionsByDepartmentChart() {
