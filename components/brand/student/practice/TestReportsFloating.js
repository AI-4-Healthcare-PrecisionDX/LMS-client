...
const DraggableResizableModal = ({ children, isOpen, onClose }) => {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-semibold">Test Reports (Move or Resize)</span>
...
export default function TestReportsFloating(props) {
  ...
  return (
    <div>
      <Button onClick={() => setIsOpen(true)} className="dark:text-white">
        <TestTubeDiagonal className="mr-2 h-4 w-4" /> Test Reports
      </Button>
