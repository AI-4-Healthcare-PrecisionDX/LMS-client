...
export default function Portfolio() {
  ...
  // const NavLink = ({ section, icon }: {section: string, icon: string}) => (
  //   <a
  //     href={`#${section}`}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-16">
                ...
                <p className="text-2xl md:text-3xl leading-relaxed">
                  I am a passionate full-stack developer with 5+ years of experience in building modern web applications. 
